...
# The scale is the pixel size of an image's shortest side
__C.TEST.SCALES = (600,)   #EDIT: 600 --> 800

# Max pixel size of the longest side of a scaled input image
__C.TEST.MAX_SIZE = 1000   #EDIT: 1000 --> 1200
...
__C.PIXEL_MEANS = np.array([[[102.9801, 115.9465, 122.7717]]])  # EDIT THIS
...
__C.FPN_ANCHOR_SCALES = [32, 64, 128, 256]#, 512]  #EDIT: REMOVING P6 --> NUM_SCALES REDUCES BY 1
