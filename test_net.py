...
if __name__ == '__main__':
  ...
  input_dir =  "fpn_3000_remove_p6_800_1200"+"/" + args.net + "/" + args.dataset
  ...
  for i in range(num_images):
      ...
      for j in xrange(1, imdb.num_classes):
          ...
          if inds.numel() > 0:
            ...
            keep = nms(cls_dets, cfg.TEST.NMS)   #edit here...observe nms is done for EACH class separately
            #keep = soft_nms(cls_dets, sigma=args.sig, method = 2)   #default_sigma
