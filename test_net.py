...
if __name__ == '__main__':
    ...
    if args.net == 'vgg16':
        ...
        fasterRCNN = resnet(imdb.classes, 101, pretrained=False, class_agnostic=args.class_agnostic, depth=args.depth)
    elif args.net == 'res50':
        fasterRCNN = resnet(imdb.classes, 50, pretrained=False, class_agnostic=args.class_agnostic, depth=args.depth)
    elif args.net == 'res152':
        fasterRCNN = resnet(imdb.classes, 152, pretrained=False, class_agnostic=args.class_agnostic, depth=args.depth)
    else:
    ...
    output_dir = os.path.join(output_dir, str(args.gamma), str(args.checkepoch), str(args.checkpoint))
